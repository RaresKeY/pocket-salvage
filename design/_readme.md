...
Design captures evolving intent. Every design document distinguishes explicit **User design** from **AI-inferred design**; name individual contributors when known. These documents are not implementation claims.
