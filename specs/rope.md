...
Ordinary endpoint motion and reeling preserve particle identity and Verlet position history, including fully taut steps. When a taut cable becomes slack, it retains the motion generated by the moving hoist instead of restarting at rest. Explicit reset and obstacle-route topology changes still initialize/remesh the cable; this is not a material-length-conserving spool simulation.
